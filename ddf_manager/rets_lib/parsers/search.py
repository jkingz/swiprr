...
from ..exceptions import MaxrowException, RETSException
...
class OneXSearchCursor(Base):
    ...
    def generator_xml(self, response, resource):
        ...
        response_dic = {
            "ReplyCode": "-1",
            "ReplyText": "No Query applied or Unknown Error occuried",
            "Count": "0",
            "Data": [],
        }
        response_dic_err = {
        ...
        if server_response_raw:
            ...
            if "ReplyCode" and "ReplyText" in server_response.keys():
                ...
                if resource in server_response["RETS-RESPONSE"].keys():
                    ...
                    response_dic["Data"] = server_response["RETS-RESPONSE"][
                        resource_details_tag
                    ]
            else:
                return response_dic
        else:
